...
export const scenes: Scene[] = [
  ...
  },
  {
    ...
    durationInFrames: 195,
    from: { scale: 1.2, x: 5, y: 2 },
    to: { scale: 1.07, x: -3, y: 0 },
  ...
  },
  {
    ...
    durationInFrames: 195,
    from: { scale: 1.05, x: -3, y: -2 },
    to: { scale: 1.17, x: 2, y: 1 },
    kicker: "Hoy",
  ...
  },
  {
    ...
    from: { scale: 1.18, x: -2, y: 2 },
    to: { scale: 1.05, x: 1, y: -1 },
  ...
  },
  {
    ...
    from: { scale: 1.14, x: 2, y: -1 },
    to: { scale: 1.03, x: -2, y: 1 },
    kicker: "Más del 80%",
